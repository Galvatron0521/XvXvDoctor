...
public class BaseActivity extends AppCompatActivity {
    ...
    //初始化各个activity的title
    public void initTitle(boolean returnBtn, boolean titleLeftDesc, String titleLeft, String
            title, boolean save, String desc) {
    ...
    public void onEventMainThread(LoginStateChangeEvent event) {
        ...
        switch (reason) {
            case user_logout:
                ...
                dialog = DialogCreator.createLogoutStatusDialog(BaseActivity.this,
